...
var $btnCalculate = document.querySelector("#btn-calculate"); // Btns Image

var $btnToDoImg = document.querySelector("#btn-todo img");
var $btnPaintImg = document.querySelector("#btn-paint img");
var $btnCalculateImg = document.querySelector("#btn-calculate img"); // Function

var $toDo = document.querySelector(".todo");
var $paint = document.querySelector(".paint");
var $calculate = document.querySelector(".calculator"); // 할 일 목록 기능

$btnToDo.addEventListener("click", function () {
  // 기능 활성화
  $toDo.classList.remove("hidden");
  $paint.classList.add("hidden");
  $calculate.classList.add("hidden"); // 버튼 이미지 활성화
...
$btnCalculate.addEventListener("click", function () {
  ...
  $paint.classList.add("hidden");
  $toDo.classList.add("hidden"); // 버튼 이미지 활성화
