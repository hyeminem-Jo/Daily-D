...
var API_KEY = "1c0df6c810c81d8611d1fc8b1549c05f"; // API key 변수 넣기

function onGeoOk(position) {
  var lat = position.coords.latitude;
  var lon = position.coords.longitude; // 위의 값들을 geolocation 에서 얻은 값으로 바꾸기
  ...
  fetch(url).then(function (response) {
    ...
    var weather = document.querySelector("#weather .weather");
    var temp = document.querySelector("#weather .temperature");
    city.innerText = data.name;
    weather.innerText = data.weather[0].main;
    temp.innerText = "".concat(data.main.temp, "\xB0");
  });
}
